...
export function RightSidebar({ children, className }: RightSidebarProps) {
	return (
		<aside
			className={cn(
				"flex w-full shrink-0 flex-col border-t bg-card lg:h-full lg:w-auto lg:overflow-y-auto lg:border-t-0",
				className
			)}
		>
			{children}
...
function SidebarSkeleton({ className }: { className?: string }) {
	return (
		<aside
			className={cn(
				"flex w-full shrink-0 flex-col gap-4 border-t bg-card p-5 lg:h-full lg:w-auto lg:overflow-y-auto lg:border-t-0",
				className
			)}
		>

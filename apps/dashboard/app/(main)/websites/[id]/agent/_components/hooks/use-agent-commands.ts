...
import { AGENT_COMMANDS, filterCommands } from "../agent-commands";
...
export function useAgentCommands() {
    ...
    const handleKeyDown = useCallback(
        ...
        [filteredCommands.length, navigateDown, navigateUp, selectCurrent, setCommandQuery, setShowCommands, showCommands]
    );

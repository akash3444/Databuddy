...
export function AgentPageContent({ websiteId: _websiteId }: AgentPageContentProps) {
                    ...
                    <div className="flex items-center gap-4 p-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-foreground/50 text-sm">Autonomous analytics assistant</p>
                            </div>
                        </div>
...
function WelcomeState({ onPromptSelect }: { onPromptSelect: (text: string) => void }) {
    return (
        <div className="flex min-h-[400px] flex-col items-center justify-center py-8">
            ...
            <div className="mb-8 max-w-md text-center">
                ...
                <p className="text-foreground/60 text-sm leading-relaxed">
                    Unlike simple assistants, the Agent autonomously explores your analytics
                    data, discovers patterns, and surfaces actionable insights without
                    step-by-step guidance.
                </p>
            </div>

            <div className="mb-8 flex flex-wrap justify-center gap-2">
                {["Deep Analysis", "Pattern Detection", "Anomaly Alerts", "Auto Reports"].map(
                    (capability) => (
                        <span
                    ...
                    {SUGGESTED_PROMPTS.map((prompt) => (
                        ...
                        >
                            <div className="flex size-8 shrink-0 items-center justify-center rounded bg-accent/50">
                                <prompt.icon className="size-4 text-foreground/60" weight="duotone" />
                            </div>

...
export function AgentStatusIndicator() {
    ...
    const { displayMessage, currentToolCall, agentStatus, isStreaming } = useChatStatus(messages, status);
        ...
        <div className="flex h-8 items-center">
            <AnimatePresence mode="wait">
                {displayMessage ? (
                    ...
                    >
                        <Icon className="size-4 animate-pulse text-foreground/50" weight="duotone" />
                    ...
                    <motion.div
                        ...
                        key="loader"
                    >
                        <CircleNotchIcon className="size-4 animate-spin text-foreground/50" weight="bold" />
                    </motion.div>
                ) : null}
            </AnimatePresence>
        </div>

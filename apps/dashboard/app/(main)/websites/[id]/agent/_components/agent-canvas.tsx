				...
				<div className="flex items-center gap-2">
					<div className="flex size-8 items-center justify-center rounded border bg-accent/50">
						{currentArtifact ? (
							...
							<TableIcon className="size-4 text-foreground/60" weight="duotone" />
						)}
					</div>
					<div>
						...
						<p className="text-foreground/50 text-xs">
							{currentArtifact ? getArtifactLabel(currentArtifact.type) : "Artifacts & visualizations"}
						</p>
					</div>
				</div>
		...
		<div className="flex h-full min-h-[400px] items-center justify-center p-8">
			<div className="flex flex-col items-center gap-4 text-center">
				<div className="flex size-16 items-center justify-center rounded border border-dashed bg-accent/20">
					<ChatCircleIcon className="size-8 text-foreground/20" weight="duotone" />
				</div>
				<div className="max-w-xs">
					<p className="mb-1 font-medium text-foreground/60 text-sm">No artifacts yet</p>
	...
	return (
		<div className="p-4">
			<div className="rounded border border-dashed bg-accent/10 p-8 text-center">
				<ArtifactIcon type={artifact.type} className="mx-auto mb-2 size-8 text-foreground/40" />
				<p className="text-foreground/70 text-sm">{artifact.title}</p>
				<p className="text-foreground/40 text-xs">Artifact rendering coming soon</p>
			</div>
		</div>
	);
}
